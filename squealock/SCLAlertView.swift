...
public enum SCLAlertViewStyle {
    case Success, Error, Notice, Warning, Info, Edit, Wait, SquealockInfo
}
...
public class SCLAlertView: UIViewController {
    ...
    public func showSquealockNotice(title: String, subTitle: String, closeButtonTitle:String?=nil, duration:NSTimeInterval=0.0) -> SCLAlertViewResponder {
        return showTitle(title, subTitle: subTitle, duration: duration, completeText:closeButtonTitle, style: .SquealockInfo)
    }
    ...
    public func showTitle(title: String, subTitle: String, duration: NSTimeInterval?, completeText: String?, style: SCLAlertViewStyle) -> SCLAlertViewResponder {
        ...
        case .SquealockInfo:
            viewColor = UIColorFromRGB(0x888888)
            iconImage = SCLAlertViewStyleKit.imageOfLock
        case .Error:
...
class SCLAlertViewStyleKit : NSObject {
    ...
    struct Cache {
        ...
        static var imageOfSquealock: UIImage?
...
//    }
    ...
    class var imageOfLock: UIImage{
        if (Cache.imageOfSquealock != nil) {
            return Cache.imageOfSquealock!
        }
            
        let hasAlpha = true
        let scale: CGFloat = 0.0 // Automatically use scale factor of main screen
        
        UIGraphicsBeginImageContextWithOptions(CGSizeMake(100, 100), !hasAlpha, scale)
        UIImage(named: "icon_padlock")!.drawInRect(CGRect(origin: CGPointZero, size: CGSizeMake(100, 100)))
        
        let scaledImage = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext() // !!!
            
        Cache.imageOfSquealock = scaledImage
